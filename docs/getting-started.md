...
**Skills and commands are just structured instructions.** They're markdown files that tell an AI assistant how to approach a specific type of task. There's no magic—if you can describe a workflow to a colleague, you can turn it into a skill.

These patterns are starting points, not prescriptions. The goal isn't to use them exactly as written—it's to:
...
3. Modify the instructions to fit your terminology, workflow, and preferences
...
From there, the AI assistant can help you draft the skill file, suggest stages, and refine the workflow.
